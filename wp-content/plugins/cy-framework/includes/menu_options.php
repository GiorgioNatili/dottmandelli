...
function cy_framework_options() {
    ...
    if(isset($_POST['label1']) or isset($_POST['label2']) or isset($_POST['label3']) or isset($_POST['label4']) or isset($_POST['termsanchor']) or isset($_POST['termslink']) or isset($_POST['formcolor'])){        
